...
title('Adversarial w/Silo Design Rounds')
axis([0, 1.1*max(indexledger), 0, 1.1*max(iterledger)])
saveas(gcf,'percentchangeadvsilo.fig')
saveas(gcf,'percentchangeadvsilo.png')
...
saveas(gcf,'numchangedadvsilo.fig')
saveas(gcf,'numchangedadvsilo.png')
